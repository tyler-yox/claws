...
### Linux 
Clone and copy the repo to the ~/.arduinoIDE folder, overwriting arduino-cli.yaml. The libraries and compilers will be downloaded by the Arduino IDE. Edit the paths in arduino-cli.yaml as needed for your user.
